...
reconstructed. The shell renders its converted oil texture unmodified (white,
full opacity, additive): the previous dimming tint underplayed the original's
vivid rainbow aura in every mode. The small silver center remains circular
while the shell changes shape.
