...
/** Development serves the local pack directly from .local; the deploy script
 * stages it after building. Shared by the app dev server and the harness. */
export function localOriginalAssets(): Plugin {
  return {
